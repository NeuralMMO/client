...
namespace Unity.Entities.CodeGen
{
    ...
    static class UserError
    {
        ...
        */
        ...
        public static DiagnosticMessage DC0048(MethodDefinition methodToAnalyze, string methodName, Instruction methodCallInstruction)
        {
            return MakeError(nameof(DC0048), $"{methodName} in {methodToAnalyze.Name} has a dynamic parameter passed in by a method call.  This method can only be invoked with a boolean literal as a parameter in Entities.ForEach.", methodToAnalyze, methodCallInstruction);
        }

        public static DiagnosticMessage DC0049(MethodDefinition methodToAnalyze, string methodName, Instruction methodCallInstruction)
        {
