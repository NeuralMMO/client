...
export class Main extends Component {
    ...
    public handleFileRead(fileReader: FileReader, jsonFile: Boolean, file: File, self: any) {
    ...
    public initLocalUpload(): void {
        ...
        file.onchange = function (e): void {
            if (file.files.length > 0) {
                ...
                self.handleFileRead(fileReader, jsonFile, file["files"][0], self);
            } else {
    ...
    public async onDemoClick(): Promise<void> {
        ...
        try {
            ...
            // Creating a DataTransfer object to simulate file selection
            const dataTransfer = new DataTransfer();
            dataTransfer.items.add(file);
            
            // Assigning the simulated selected file to the input element
            ...
            // Handle file read
            this.handleFileRead(fileReader, jsonFile, file, this);

            // Triggering onchange event manually
