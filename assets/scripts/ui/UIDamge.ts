...
export class UIDamge extends Component {
    ...
    start() {
        ...
        let toPos = new Vec3(math.randomRangeInt(-40, 40), math.randomRangeInt(10, 30)).add(this.text.node.position);
        
        let node = this.node;

        let time = GlobalConfig.BASE_DMG_TIME / GlobalConfig.SpeedRate;
